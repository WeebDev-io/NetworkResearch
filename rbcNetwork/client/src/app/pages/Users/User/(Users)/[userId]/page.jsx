...
const User = ({ params }) => {
  ...
  const userInfoScheme = [
    { label: 'Name', data: params.userId, age: false },
  ...
  const aboutMe = [
    { id: 1, type: "Education", name: 'Education' },
    { id: 2, type: "Location", name: 'Location' },
    { id: 3, type: "Work", name: 'Work' },
    { id: 4, type: "Work Role", name: 'Work Role' },
    { id: 5, type: "Life events", name: 'Life events' },
  ]
  ...
  return (
    <div className={`profileContainer`}>
      <h2 className={`profileHeader`}>{`${params.userId}'s Profile`}</h2>
      {userData.map(data => (
        currSession == data.user && data.myNetwork.map(user => {
          const userId = params.userId;
          if (user.name == userId) {
            return (
              <div key={userId} className={`profileContentHolder`} >
                  ...
                  <div className={`profileContentContainer`}>
                    ...
                    <div className={`showHideInfo`}>
                      <div className={`profilePortfolioButton`}>
                        <Link href={`/pages/Users/Portfolio/${userId}`} className={`link`}>Portfolio</Link>
                      </div>
                      ...
                      <div className={`profilePersonalInfo`}>
                        ...
                        <div className={`profilePersonalInfoContainer`}>
                          ...
                          <div className={`profileAboutInfo`}>
                            {aboutMe.map((about) => (
                              <div key={about.id} className={`profileInfoHolder`}>
