...
const UpdatesCard = ({servicesIcon,servicesName,servicesDesc})=>(
...
const Updates = () => {
  ...
  <div className={style.main.Container}>
    <div className={style.main.Holder}>
      <h2 className={style.main.Header}>Updates</h2>
      <div className={style.main.ContentHolder}>
        <p className={style.main.Paragraph}> Whats changed ? 
        <FontAwesomeIcon icon='caret-down' className={style.main.Icon}/> 
        </p>
        <div className={style.main.CardHolder}>
          <UpdatesCard bg="" servicesIcon="user" servicesName="#1 Update Name" servicesDesc="Update Desc" />
          <UpdatesCard bg="" servicesIcon="pencil" servicesName="#2 Update Name" servicesDesc="update Desc" />
          <UpdatesCard bg="" servicesIcon="pencil" servicesName="#3 Update Name" servicesDesc="update Desc" />
          <UpdatesCard bg="" servicesIcon="headset" servicesName="#4 Update Name" servicesDesc="update Desc" />
          <UpdatesCard bg="" servicesIcon="bug-slash" servicesName="#5 Update Name" servicesDesc="update Desc" />
          <UpdatesCard bg="" servicesIcon="sitemap" servicesName="#6 Update Name" servicesDesc="update Desc" />
          <UpdatesCard bg="" servicesIcon="face-grin-beam" servicesName="#7 Update Name" servicesDesc="update Desc" />
          <UpdatesCard bg="" servicesIcon="mug-hot" servicesName="#8 Update Name" servicesDesc="update Desc" />
          <UpdatesCard bg="" servicesIcon="calendar" servicesName="#9 Update Name" servicesDesc="update Desc" />
          <UpdatesCard bg="" servicesIcon="pencil" servicesName="#10 Update Name" servicesDesc="update Desc" />
          <UpdatesCard bg="" servicesIcon="user" servicesName="#1 Update Name" servicesDesc="Update Desc" />
          <UpdatesCard bg="" servicesIcon="pencil" servicesName="#2 Update Name" servicesDesc="update Desc" />
          <UpdatesCard bg="" servicesIcon="pencil" servicesName="#3 Update Name" servicesDesc="update Desc" />
          <UpdatesCard bg="" servicesIcon="headset" servicesName="#4 Update Name" servicesDesc="update Desc" />
...
UpdatesCard.propTypes = {bg:PropTypes.string,servicesIcon:PropTypes.string,servicesName:PropTypes.string,servicesDesc:PropTypes.string,}
